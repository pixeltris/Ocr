...
namespace Cyotek.Windows.Forms
{
    ...
    internal class ImageBoxEx : ImageBox
    {
        ...
        private bool _centerDragHandles;
        ...
        [Category("Appearance")]
        [DefaultValue(false)]
        public virtual bool CenterDragHandles
        {
            get { return _centerDragHandles; }
            set
            {
                if (this.CenterDragHandles != value)
                {
                    _centerDragHandles = value;
                }
            }
        }
        ...
        private void PositionDragHandles()
        {
            if (this.DragHandles != null && this.DragHandleSize > 0)
            {
                ...
                else
                {
                    ...
                    dragHandleOffset = CenterDragHandles ? halfDragHandleSize : 0;
                    ...
                    this.DragHandles[DragHandleAnchor.TopLeft].Bounds = new Rectangle(left - this.DragHandleSize + dragHandleOffset, top - this.DragHandleSize + dragHandleOffset, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.TopCenter].Bounds = new Rectangle(left + halfWidth - halfDragHandleSize, top - this.DragHandleSize + dragHandleOffset, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.TopRight].Bounds = new Rectangle(right - dragHandleOffset, top - this.DragHandleSize + dragHandleOffset, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.MiddleLeft].Bounds = new Rectangle(left - this.DragHandleSize + dragHandleOffset, top + halfHeight - halfDragHandleSize, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.MiddleRight].Bounds = new Rectangle(right - dragHandleOffset, top + halfHeight - halfDragHandleSize, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.BottomLeft].Bounds = new Rectangle(left - this.DragHandleSize + dragHandleOffset, bottom - dragHandleOffset, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.BottomCenter].Bounds = new Rectangle(left + halfWidth - halfDragHandleSize, bottom - dragHandleOffset, this.DragHandleSize, this.DragHandleSize);
                    this.DragHandles[DragHandleAnchor.BottomRight].Bounds = new Rectangle(right - dragHandleOffset, bottom - dragHandleOffset, this.DragHandleSize, this.DragHandleSize);
                }
            }
        }
